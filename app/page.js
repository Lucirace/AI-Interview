...
export default function Home() {
  return (
    <div>
      ...
      <section className="py-4 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
